import type { IntentSpec, Plan, PlanStep, Diagnostic, IntentPage } from "./types.js";
...
export async function compileViteReactIntent(intent: IntentSpec, ws: WorkspaceReader): Promise<{ plan?: Plan; diagnostics: Diagnostic[] }> {
